...
2. Second Step - Use Sentiment Analysis R script, to do the sentiment analysis of the comments. This sentiment analysis based on wordcloud technique and every preprocessing steps of text is implemented, each step explained in the code.
